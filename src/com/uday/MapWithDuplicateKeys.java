...
class MapWithDuplicateKeys
{
    ...
    public static void main(String[] args)
    {
        ...
        MultiMap<Integer, String> multimap = new MultiMap<Integer, String>();
 
        multimap.put(1, "Taylor");
        multimap.put(1, "Taylor");
        multimap.put(2, "Adams");
        multimap.put(3, "Tyler");
        multimap.put(1, "Kennedy");
        multimap.put(1, "Washington");
        multimap.put(2, "Bush");
        multimap.put(2, "Cleveland");
 
        System.out.println("----- Printing Multimap using keySet -----\n");
        for (int lastName : multimap.keySet()) {
